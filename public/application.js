...
/***/ function(module, exports, __webpack_require__) {
	...
	var teaEvents = __webpack_require__(35);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://dry-oasis-74645.herokuapp.com'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var teaApi = __webpack_require__(12);
	var teaUi = __webpack_require__(13);
	var teaEvents = __webpack_require__(35);
	...
	var signInSuccess = function signInSuccess() {
	  ...
	  teaApi.indexTeas().then(teaUi.indexSuccess);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexTeas = function indexTeas() {
	  return $.ajax({
	...
	var showTea = function showTea(id) {
	  return $.ajax({
	...
	var createTea = function createTea(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/teas',
	    method: 'POST',
	    headers: {
	...
	var updateTea = function updateTea(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/teas/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var destroyTea = function destroyTea(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/teas/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var teaHandlebars = __webpack_require__(14);

	var indexSuccess = function indexSuccess(data) {
	  for (var i = 0; i < data.teas.length; i++) {
	  ...
	  var teasIndexHtml = teaHandlebars({
	    teas: data.teas
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div data-id=\""
	    ...
	    + "\">\n  <!-- Are we going to display id? -->\n  <div class=\"handlebars-container col-xs-12\">\n    <tr>\n      <div id=\"tea-row"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <td class=\"tea-display-row tea-display-row"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><p class=\"name tea-display-group\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</p></td>\n    <td class=\"tea-display-row tea-display-row"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><p class=\"type tea-display-group\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.type : stack1), depth0))
	    + "</p></td>\n    <td class=\"tea-display-row tea-display-row"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><p class=\"steepTime tea-display-group\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1), depth0))
	    + "</p></td>\n    <td class=\"tea-display-row tea-display-row"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><p class=\"description tea-display-group\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p></td>\n    <td class=\"tea-display-row tea-display-row"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><button id=\"steep-btn\" class=\"btn-steep tea-display-group btn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Steep</button>\n      <button id=\"options-btn\" class=\"tea-display-group btn glyphicon glyphicon-menu-down\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"collapse\" data-target=\"#collapseUpdate"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"></button>\n    </td>\n\n</div>\n\n<td colspan=\"5\" class=\"tea-update-form tea-update-form"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n       <form class=\"teas\" id=\"update-tea\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n         <div class=\"form-group\">\n\n           <span>Name</span>\n           <input type=\"text\" class=\"update-cell\" required=\"required\" id=\"tea-name-update\" name=\"tea[name]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" maxlength=\"150\" placeholder=\"Name\">\n\n           <span>Type</span>\n           <select required=\"required\" class=\"update-cell\" name=\"tea[type]\">\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"Black",((stack1 = blockParams[0][0]) != null ? stack1.type : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"Black\">Black</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"Green",((stack1 = blockParams[0][0]) != null ? stack1.type : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"Green\">Green</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"White",((stack1 = blockParams[0][0]) != null ? stack1.type : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"White\">White</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"Other",((stack1 = blockParams[0][0]) != null ? stack1.type : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"Other\">Other</option>\n           </select>\n\n           <span>Steep Time</span>\n           <select required=\"required\" class=\"update-cell\" value=\"tea.steepTime\" name=\"tea[steepTime]\">\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"30",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"30\">30 seconds</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"60",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"60\">1 minute</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"90",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"90\">1 minute 30 seconds</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"120",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"120\">2 minutes</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"150",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"150\">2 minutes 30 seconds</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"180",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"180\">3 minutes</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"210",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"210\">3 minutes 30 seconds</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"240",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"240\">4 minutes</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"270",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"270\">4 minutes 30 seconds</option>\n             <option "
	    + alias2(__default(__webpack_require__(34)).call(alias3,"300",((stack1 = blockParams[0][0]) != null ? stack1.steepTime : stack1),{"name":"teaType","hash":{},"data":data,"blockParams":blockParams}))
	    + " value=\"300\">5 minutes</option>\n           </select>\n\n           <span>Description</span>\n           <input type=\"text\" name=\"tea[description]\" required=\"required\" id=\"tea-description-update\" class=\"update-cell\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "\" placeholder=\"taste, color...\" maxlength=\"500\">\n\n         </div>\n         <span></span>\n           <button type=\"submit\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"update-tea-btn\" class=\"btn btn-tea-success update-tea-btn update-tea-btn"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Submit Edit</button>\n\n\n\n       </form>\n       </td>\n       <!-- <div id=\"clear-div\"></div> -->\n\n\n     <!-- <div class=\"collapse update-collapse\" id=\"collapseUpdate"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <div class=\"well\">\n      </div>\n      </div> -->\n\n  </tr>\n  <tr>\n      <td colspan=\"5\" class=\"hiddenRow\">\n        <div class=\"accordian-body collapse options-row\" id=\"collapseUpdate"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <button id=\"edit-tea-row\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"edit-delete-btns btn btn-tea-success btn-xs glyphicon glyphicon-pencil\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Edit\"> Edit\n        <button type=\"button\" id=\"delete-tea\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"edit-delete-btns btn btn-delete btn-xs glyphicon glyphicon-trash\"> Delete</button>\n      </button>\n      <!-- <input type=\"submit\" form=\"update-tea"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"update-tea-btn\" class=\"btn btn-success update-tea-btn update-tea-btn"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Edit\"> -->\n    </div>\n    </td>\n  </tr>\n  </div>\n\n</div>\n\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n\n<table id=\"tea-table\">\n  <tr id=\"tea-table-row\" data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.tea : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <th>Name</th>\n    <th>Type</th>\n    <th>Steep Time</th>\n    <th>Description </th>\n    <th>Start Steep Timer</th>\n  </tr>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.teas : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</table>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexTeas = function onIndexTeas(event) {
	  event.preventDefault();
	  api.indexTeas().then(ui.indexSuccess).catch(ui.onError);
	};

	var onCreateTeas = function onCreateTeas(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createTea(data).then(ui.createSuccess).then(api.indexTeas).then(ui.indexSuccess).catch(ui.failure);
	};

	var onUpdateTea = function onUpdateTea(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  var data = getFormFields(event.target);
	  api.updateTea(id, data).then(ui.updateSuccess).then(api.indexTeas).then(ui.indexSuccess).catch(ui.failure);
	};

	var onDestroyTea = function onDestroyTea(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  api.destroyTea(id).then(ui.destroySuccess).then(api.indexTeas).then(ui.indexSuccess).catch(ui.failure);
	};

	var teaDropdownToggle = function teaDropdownToggle(event) {
	  $(event.target).toggleClass('glyphicon-menu-down');
	  $(event.target).toggleClass('glyphicon-menu-up');
	};

	var teaRowToggle = function teaRowToggle(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	...
	var _timerLogic = void 0;

	var audio = $('#alert-audio');
	var playing = void 0;
	...
	var startTimer = function startTimer(duration, display) {
	  ...
	  _timerLogic = function timerLogic() {
	    ...
	    if (--timer < 0) {
	      ...
	      audioPlay();
	      endTimer(_timerLogic);
	      isRunning = false;
	      return isRunning;
	    }
	  };
	  _timerLogic();
	  _timerLogic = setInterval(_timerLogic, 1000);
	};

	var endTimer = function endTimer(timerLogic) {
	  clearInterval(timerLogic);
	};

	var clearIntSignOut = function clearIntSignOut() {
	  clearInterval(_timerLogic);
	  isRunning = false;
	  audioPause();
	};

	var loadTime = function loadTime(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  api.showTea(id).then(function (data) {
	    if (isRunning === false) {
	      $('#timer-done-message').text('');
	...
	var cancelTimer = function cancelTimer(event) {
	  event.preventDefault();
	  endTimer(_timerLogic);
	  isRunning = false;
	  $('#timer-main-text').text('');
	...
	var addTeaHandlers = function addTeaHandlers() {
	...
	module.exports = {
	  onCreateTeas: onCreateTeas,
	  onIndexTeas: onIndexTeas,
	  onUpdateTea: onUpdateTea,
	  addTeaHandlers: addTeaHandlers,
	  startTimer: startTimer,
	  clearIntSignOut: clearIntSignOut,
	  endTimer: endTimer
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "62a9d3622a87e70d0b14154f33f682cc.png";
